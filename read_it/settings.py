"""
Django settings for read_it project.
...
CSRF_TRUSTED_ORIGINS = [os.getenv("DJANGO_TRUSTED_ORIGIN")]
...
WSGI_APPLICATION = "read_it.wsgi.application"
...
STATIC_ROOT = os.getenv("DJANGO_STATIC_PATH")
STATIC_URL = "static/"
